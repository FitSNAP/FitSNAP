...
class Groups(Section):
    ...
    def __init__(self, name, config, args):
        ...
        self.allowedkeys = ['group_sections', 'group_types', 'smartweights', 'random_sampling', 'random_seed', 'vasp_json_pathname','vasp_TOTEN','vasp_ignore_incomplete','vasp_ignore_jsons','BOLTZ']
        ...
        self.vasp_TOTEN = self.get_value("GROUPS", "vasp_TOTEN", "0", "bool")
