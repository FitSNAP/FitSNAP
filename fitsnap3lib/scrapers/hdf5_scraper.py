...
class HDF5(Scraper):
    ...
    def __init__(self, name, pt, config, filename="/Users/mitch/Dropbox/github/hmx/spice/spice20.hd5"):
    ...
    def _scrape_group(self, group, i):
        ...
        dft_total_energy = group["dft_total_energy"][()]
        ...
        self.data.append({
            ...
            "dft_total_energy": dft_total_energy[i] * HARTREE_TO_KCAL_MOL,
